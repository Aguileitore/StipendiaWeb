...
PreparedStatement pst=null;
    ...
    private void initComponents() {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/StipendiaWeb/Images/Calculate.png"))); // NOI18N
        ...
        jButton2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/StipendiaWeb/Images/erase-128.png"))); // NOI18N
        ...
        txt_Save.setIcon(new javax.swing.ImageIcon(getClass().getResource("/StipendiaWeb/Images/Save-icon.png"))); // NOI18N
    ...
    private void txt_SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_SaveActionPerformed
        ...
        int p = JOptionPane.showConfirmDialog(null, "Estas seguro de guardar?","DAto guardado",JOptionPane.YES_NO_OPTION);
        if(p==0){
